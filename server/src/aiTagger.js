...
const TAG_TOOL = {
  ...
  description:
    'Record the breakdown elements (cast, props, wardrobe, vehicles, special effects, sound, hair/makeup, animals, background extras) that are explicitly present or clearly implied in the given scene.',
  input_schema: {
    type: 'object',
    properties: {
      elements: {
...
named characters (cast), physical props characters interact with (props), notable clothing/costume items (wardrobe),
vehicles (vehicles), practical or visual effects (sfx), notable sounds/music cues (sound), hair/makeup/prosthetics
needs (makeup), animals (animals), and background/crowd performers (extras).
